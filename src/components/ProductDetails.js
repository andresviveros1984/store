...
const ProductDetails = ({ setCartItem }) => {
  let { id } = useParams();

  const cartItems = useStore((state) => state.cartItems);
  const addItems = useStore((state) => state.addToCart);
